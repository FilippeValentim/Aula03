...
public class AsiaActivity extends AppCompatActivity {
    ...
    public ArrayList<String> geraListaChamados(){
        ...
        lista.add("Afeganistão");
        lista.add("Arábia Saudita");
        lista.add("Catar");
        lista.add("Cazaquistão");
        lista.add("China");
        lista.add("Coreia do Norte");
        lista.add("Coreia do Sul");
        lista.add("Índia");
        lista.add("Irão");
        lista.add("Israel");
        lista.add("Japão");
